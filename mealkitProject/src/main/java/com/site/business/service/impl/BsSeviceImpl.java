package com.site.business.service.impl;

import java.util.ArrayList;
import java.util.HashMap;
import java.util.Map;

import com.site.business.dao.BsDao;
import com.site.business.service.BsService;
...
public class BsSeviceImpl implements BsService {
	...
	public Map<String, Object> businessList(int page, String category, String searchWord) {
		...
		int listCount = bsDao.businessListCount(category,searchWord);//업체 총 개수
		...
		//업체 리스트
		ArrayList<StoreVo> list = bsDao.businessList(startrow,endrow,category,searchWord);
	...
	public Map<String, Object> businessView(String id) {
		Map<String, Object> map = new HashMap<String, Object>();
		ArrayList<StoreVo> list = bsDao.businessView(id);
		map.put("list", list);
		return map;
	}
